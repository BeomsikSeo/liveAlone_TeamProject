...
import com.multi.liveAlone.share.messageShare.MessageShareConfig;


@Configuration
@ComponentScan(excludeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = MessageShareConfig.class))
