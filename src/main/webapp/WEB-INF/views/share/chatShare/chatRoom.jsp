...
<script type="text/javascript">
	...
	var user1_tradeState = false; 
	var user2_tradeState = false;
	var nowSession = ${id};
	var user1 = ${roomInfo.chatRequestor};
	var user2 = ${roomInfo.chatReceiver};
	...
	function tradeCheck(){
		if(user1_tradeState == false && user1 == ${id}){
			user1_tradeState = true;
		}
		if(user2_tradeState == false && user2 == ${id}){
			user2_tradeState = true;
		}
